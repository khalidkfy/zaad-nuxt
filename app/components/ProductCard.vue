...
<template>
    <div class="product-card" :aria-label="`Product: ${product?.title}`">
        ...
        <div class="img-box">
            <div class="cart">
                <NuxtImg width="19" height="19" src="/assets/images/addcart.svg" :title="$t('cart.add')"
                    :alt="$t('cart.add')" />


            </div>
            <div class="whish" :title="$t('whish.add')">
            ...
            <NuxtImg class="product" width="185" :src="product?.src" :alt="product?.title" :title="product?.title" />
        </div>
        <NuxtLink :style="{ 'color': textColor ? textColor : '' }" v-if="showCateg" href="/" class="categ">{{
        ...
        <NuxtLink href="/" class="product-info">
            ...
            <div class="price">
                <div>
                    <span :style="{ 'color': textColor ? textColor : '' }" class="amount">{{ product?.regular_price
                        }}</span>

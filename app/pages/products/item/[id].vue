...
const { productDetails, getProductDetailsLoading, getProductDetails, productRates } =
  useProducts();
...
useSeo({
  ...
  title: t('meta.setMeta', { meta: productDetails.value?.seo.title || productDetails.value?.title }),
...
<template>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-5">
          <div class="info">
            <div>
              <NuxtLink class="categ" :href="$localePath(`/products/${productDetails?.category_id}`)">{{
              ...
              <div>
                <div class="qty">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                      <g clip-path="url(#clip0_142_912)">
                        <path
                          ...
                          :stroke="qty == 1 ? '#444C4E' : 'black'" stroke-width="1.5" stroke-linecap="round"
                          stroke-linejoin="round" />
                        <path d="M9 12H15" :stroke="qty == 1 ? '#444C4E' : 'black'" stroke-width="1.5"
                  ...
                  <span>{{ qty }}</span>
                  <div :class="{ disabled: qty == productDetails?.quantity }" @click.prevent="addQty()">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <div>
              <div class="terms">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                  <g clip-path="url(#clip0_117_1009)">
                    <path d="M8 6H8.00667" stroke="#F78400" stroke-width="1.5" stroke-linecap="round"
                      stroke-linejoin="round" />
                    <path d="M7.33301 8H7.99967V10.6667H8.66634" stroke="#F78400" stroke-width="1.5"
                      stroke-linecap="round" stroke-linejoin="round" />
                  </g>
                  <path
                    ...
                    stroke="#F78400" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                  <defs>
              ...
              <div class="mt-4 btns"> 
                ...
                <button :disabled="addToCartLoading || qty < 1" @click.prevent="addToCart(productDetails?.id, qty)"
                  class="btn-cart" v-if="!isCartItem" title="اضف الى السلة">
                ...
                <button :disabled="addToCartLoading" @click.prevent="
                  deleteFromCart({ item_id: productDetails?.id })
                  " class="btn-cart remove" v-else title="ازالة من السلة">
                  <svg v-if="!deleteCartLoading" xmlns="http://www.w3.org/2000/svg" width="19" height="19"
                    viewBox="0 0 19 19" fill="none">
                    <path
                      d="M15.3955 17.4792C16.0858 17.4792 16.6455 16.9195 16.6455 16.2292C16.6455 15.5389 16.0858 14.9792 15.3955 14.9792C14.7052 14.9792 14.1455 15.5389 14.1455 16.2292C14.1455 16.9195 14.7052 17.4792 15.3955 17.4792Z"
                      fill="#fff" stroke="#fff" stroke-width="1.625" stroke-linecap="round" stroke-linejoin="round" />
                    <path
                      d="M7.0625 17.4792C7.75283 17.4792 8.3125 16.9195 8.3125 16.2292C8.3125 15.5389 7.75283 14.9792 7.0625 14.9792C6.37214 14.9792 5.8125 15.5389 5.8125 16.2292C5.8125 16.9195 6.37214 17.4792 7.0625 17.4792Z"
                      fill="#fff" stroke="#fff" stroke-width="1.625" stroke-linecap="round" stroke-linejoin="round" />
                    <path
                      d="M3.3125 2.47917H17.4792L15.8125 11.6458H4.97917L3.3125 2.47917ZM3.3125 2.47917C3.17361 1.92361 2.47917 0.8125 0.8125 0.8125"
                      stroke="#fff" stroke-width="1.625" stroke-linecap="round" stroke-linejoin="round" />
                    <path
                      d="M15.8118 11.6459H4.97852H3.50416C2.01723 11.6459 1.22852 12.2969 1.22852 13.3125C1.22852 14.3282 2.01723 14.9792 3.50416 14.9792H15.3952"
                      stroke="#fff" stroke-width="1.625" stroke-linecap="round" stroke-linejoin="round" />
                  </svg>
  ...
  <section class="mt-4">
      ...
      <div class="row">
        <div class="col-md-7">
          <div class="product-tabs">
            <div @click.prevent="changeTab('rates')" :class="{ active: activeTab === 'rates' }" class="tab">
              {{ $t("general.rates") }}
            </div>
            <div @click.prevent="changeTab('desc')" :class="{ active: activeTab === 'desc' }" class="tab">
              {{ $t("general.desc") }}
            </div>
          </div>
          <hr />
                  ...
                  <div class="rates">
                    <div class="rate">
                      <div v-if="productDetails?.rates?.user_rate" class="rate-value">
                        <span class="date"> {{ productDetails?.rates?.user_rate?.date }}</span>
                    ...
                    <div class="rate-labels">
                      <div class="label">
                        ...
                        <div class="bar">
                          <div class="fill" :style="{ width: `${productRates?.five_stars || 0}%` }"></div>
                        </div>
                      </div>
                      <div class="label">
                        <div>
                        ...
                        <div class="bar">
                          <div class="fill" :style="{ width: `${productRates?.four_stars || 0}%` }"></div>
                        </div>
                      </div>
                      <div class="label">
                        <div>
                        ...
                        <div class="bar">
                          <div class="fill" :style="{ width: `${productRates?.three_stars || 0}%` }"></div>
                        </div>
                      ...
                      <div class="label">
                        ...
                        <div class="bar">
                          <div class="fill" :style="{ width: `${productRates?.two_stars || 0}%` }"></div>
                        </div>
                      </div>
                      <div class="label">
                        <div>
                        ...
                        <div class="bar">
                          <div class="fill" :style="{ width: `${productRates?.one_stars || 0}%` }"></div>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div class="col-md-5">
          <div @click="handleShareClick" class="share-item">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                  <g clip-path="url(#clip0_124_49)">
                    <path
                      ...
                      stroke="#2B2932" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path
                    ...
                    <path
                      ...
                      stroke="#2B2932" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M10.1504 12.4833L17.8504 8.51666" stroke="#2B2932" stroke-width="2" stroke-linecap="round"
                      stroke-linejoin="round" />
                    <path d="M10.1504 15.5167L17.8504 19.4833" stroke="#2B2932" stroke-width="2" stroke-linecap="round"
                      stroke-linejoin="round" />
                  </g>
                  <defs>
            ...
            <div class="arrow">
              <img loading="lazy" src="/assets/images/arrow.svg" alt="arrow" width="16" height="8" />
            </div>
    ...
    <div class="modal addRateModal fade" id="addRateModal" role="dialog" tabindex="-1" aria-labelledby="addRateModal"
      aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div v-if="getError('rateSubmit')" class="alert alert-danger alert-dismissible fade show" role="alert">
              {{ getError("rateSubmit") }}
              <button type="button" class="btn-close" @click="clearError('rateSubmit')" aria-label="Close"></button>
            </div>
            <template>
                ...
                <div class="mb-3">
                  ...
                  <div class="submit-rate">
                    <svg @click.prevent="submitRateValue = i" v-for="i in 5" :key="i" xmlns="http://www.w3.org/2000/svg"
                      width="25" height="25" viewBox="0 0 20 20" fill="none">
                      <g clip-path="url(#clip0_117_895)">
                        <path
                          d="M14.2566 18.4042C13.2016 18.3475 11.8199 17.6883 10.0308 16.4417L9.99743 16.4192L9.96659 16.4417C8.17743 17.6892 6.7966 18.3483 5.73993 18.405L5.59159 18.4092C3.30243 18.4092 3.01076 16.2092 4.15993 12.3725L4.20493 12.2242L4.12159 12.1617C-0.925072 8.29668 -0.0834054 5.62168 6.24993 5.44001L6.41826 5.43584L6.51409 5.16418C7.50076 2.38918 8.53576 0.926677 9.86993 0.83751L9.99993 0.833344C11.3949 0.833344 12.4641 2.30001 13.4849 5.16418L13.5799 5.43584L13.7499 5.44001C20.0833 5.62168 20.9249 8.29668 15.8774 12.1608L15.7924 12.2233L15.8383 12.3717C16.9633 16.1317 16.7049 18.3192 14.5416 18.405L14.4058 18.4075L14.2566 18.4042Z"
